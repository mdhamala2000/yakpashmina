...
const AddProductColor = () => {
   ...
   const getData=()=>{
    ...
    const handleSubmit = (e) => {
        ...
        if (name === "") {
            context.alertBox("error", "Please enter product color");
            return false;
        }
        ...
        if(editId===""){
            ...
            postData(`/api/product/productColor/create`, {
                name: name
            }).then((res) => {
                if(res?.error===false){
        ...
        if(editId!==""){
            editData(`/api/product/productColor/${editId}`, {
                name: name
            }).then((res) => {
    ...
    const deleteItem = (id) => {
        deleteData(`/api/product/productColor/${id}`).then((res) => {
            getData();
    ...
    const editItem=(id)=>{
        fetchDataFromApi(`/api/product/productColor/${id}`).then((res)=>{
