...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={`sidebar fixed top-0 left-0 z-[52] bg-white h-full border-r border-gray-200 py-2 px-4 ${context.isSidebarOpen ? 'w-[260px]' : 'w-0 overflow-hidden'}`}>
...
<Link to="/">
            <img
              ...
              className="w-[70px] md:min-w-[80px]"
            />
          </Link>
        </div>
