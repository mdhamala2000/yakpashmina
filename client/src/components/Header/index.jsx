        ...
        <div className="top-strip hidden lg:block py-2 border-t-[1px] border-gray-250  border-b-[1px]">
          <div className="container">
            <div className="flex items-center justify-between">
              <div className="col1 w-[50%] hidden lg:flex items-center gap-4">
                <RegionDisplay />
                <p className="text-[12px] font-[500] mt-0 mb-0 text-red-600">
                  Buy Premium Pashmina Products from Nepal – Authentic, Soft & Sustainable
                </p>
              </div>

              <div className="col2 flex items-center justify-between w-full lg:w-[50%] lg:justify-end">
                <ul className="flex items-center gap-3 w-full justify-between lg:w-auto lg:gap-6">
