...
const SearchPage = () => {
  ...
  const productsData = context?.searchData || [];
  const [sortedProductsData, setSortedProductsData] = useState(null);

  const displayProducts = sortedProductsData || productsData;
            ...
            <div className="bg-[#f1f1f1] p-2 w-full mb-4 rounded-md flex items-center justify-between sticky top-[135px] z-[99]">
              <div className="col1 flex items-center itemViewActions">
                ...
                <span className="text-[14px] hidden sm:block md:block lg:block font-[500] pl-3 text-[rgba(0,0,0,0.7)]">
                  There are {displayProducts?.products?.length !== 0 ? displayProducts?.products?.length : 0}  products.
                </span>
              </div>

              <div className="col2 ml-auto flex items-center justify-end gap-3 pr-4">
                <span className="text-[13px] font-semibold text-gray-700 pl-3">
                  Sort by
                </span>
                ...
                <Button
                  ...
                  onClick={handleClick}
                  className="!bg-white !text-[13px] !text-gray-700 !capitalize !border !border-gray-300 !px-4 !py-1.5 !min-w-[120px] !rounded-lg !font-semibold hover:!border-gray-400"
                >
                  {selectedSortVal}
                </Button>
                ...
                >
                  <MenuItem
                    onClick={() => handleSortBy('name', 'asc', displayProducts, 'Name, A to Z')}
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('name', 'desc', displayProducts, 'Name, Z to A')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
                    Name, Z to A
                  </MenuItem>
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('price', 'asc', displayProducts, 'Price, low to high')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
                    Price, low to high
                  </MenuItem>
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('price', 'desc', displayProducts, ' Price, high to low')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
                    Price, high to low
                  </MenuItem>
...
displayProducts?.products?.length !== 0 && displayProducts?.products?.map((item, index) => {
                          return (
