...
const AddAddress = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const noZipCountries = ['hong kong', 'hk', 'macau', 'macao', 'singapore'];
        const countryLower = (formFields.country || '').toLowerCase().trim();
        
        if (formFields.pincode === "" && !noZipCountries.includes(countryLower)) {
        ...
        if (phone === "" || phone?.length < 5) {
            context.alertBox("error", "Please enter your mobile number");
            return false
        }
